...
BOARD_AVB_VBMETA_SYSTEM_KEY_PATH := vendor/realme/keys/mykey_rsa4096.pem
BOARD_AVB_RECOVERY_KEY_PATH := vendor/realme/keys/mykey_rsa4096.pem
...
BOARD_USERDATAIMAGE_PARTITION_SIZE := 116287266816     # ~108GB

# Super Partition Sizes 
BOARD_SUPER_PARTITION_SIZE := 8126177280               # exact: 0x1E7C00000 (from dump)
BOARD_QTI_DYNAMIC_PARTITIONS_SIZE := 8121982976        # 8126177280 - 4194304 buffer (4MB)
...
BOARD_SYSTEMIMAGE_PARTITION_RESERVED_SIZE := 805306368        # 805MB
BOARD_SYSTEM_EXTIMAGE_PARTITION_RESERVED_SIZE := 268435456    # 256MB
BOARD_PRODUCTIMAGE_PARTITION_RESERVED_SIZE := 805306368       # 805MB
BOARD_VENDORIMAGE_PARTITION_RESERVED_SIZE := 705306368        # 705MB
